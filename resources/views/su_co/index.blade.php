                    ...
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-footer d-flex gap-2">
                            <a href="{{ route('suco.show', $sc->id) }}"
                               class="btn btn-sm flex-fill btn-secondary">Chi tiết</a>

                            <a href="{{ route('suco.edit', $sc->id) }}"
                               class="btn btn-sm btn-warning flex-fill">Sửa</a>

                            <form action="{{ route('suco.destroy', $sc->id) }}"
                                  method="POST" style="display:inline-block" class="mb-0">
                                @csrf
                                @method('DELETE')
...
<style>
    ...
    .badge{border-radius:10rem; padding:.35rem .6rem; font-weight:600}
</style>
@endpush
@endsection
