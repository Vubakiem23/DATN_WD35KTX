...
<div class="container-fluid">
    ...
    <script>
        window.addEventListener('DOMContentLoaded', () => {
            (window.showToast || alert)(@json(session('status')), 'success')
        });
    </script>
    @endpush
    <noscript>
    ...
    <script>
        window.addEventListener('DOMContentLoaded', () => {
            (window.showToast || alert)(@json(strip_tags(session('error'))), 'error')
        });
    </script>
    @endpush
    <noscript>
    ...
    <style>
        ...
        .room-pagination__summary {
            font-size: .78rem;
            color: #6b7280
        }

        .room-pagination__nav .pagination {
            margin-bottom: 0
        }
        ...
        @media (max-width:992px) {
            ...
            .room-table tbody td[data-label] {
                position: relative;
                padding-left: 130px
            }

            .room-table tbody td[data-label]::before {
