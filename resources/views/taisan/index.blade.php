...
<div class="container mt-4">
    ...
    <form method="GET" action="{{ route('taisan.index') }}" class="mb-3 search-bar">
        <div class="input-group">
            ...
            <button type="submit" class="btn btn-outline-secondary"><i class="fa fa-search"></i> Tìm</button>
            @if(request('search') || request('phong_id'))
            <a href="{{ route('taisan.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('taisan.create') }}" class="btn btn-outline-primary">
