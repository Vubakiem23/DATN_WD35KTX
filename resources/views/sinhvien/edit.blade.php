    ...
    <form method="POST" action="{{ route('sinhvien.update', $sinhvien->id) }}">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="ma_sinh_vien" value="{{ $sinhvien->ma_sinh_vien }}" class="form-control" required>
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="noi_o_hien_tai" value="{{ $sinhvien->noi_o_hien_tai }}" class="form-control" required>
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="so_dien_thoai" value="{{ $sinhvien->so_dien_thoai }}" class="form-control" required>
            </div>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="phong_id" class="form-select" required>
                    @foreach($phongs as $phong)
                        <option value="{{ $phong->id }}" {{ $sinhvien->phong_id == $phong->id ? 'selected' : '' }}>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="trang_thai_ho_so" class="form-select">
                    <option value="Chờ duyệt" {{ $sinhvien->trang_thai_ho_so == 'Chờ duyệt' ? 'selected' : '' }}>Chờ duyệt</option>
                    <option value="Đã duyệt" {{ $sinhvien->trang_thai_ho_so == 'Đã duyệt' ? 'selected' : '' }}>Đã duyệt</option>
                </select>
            </div>
        </div>
